...
object BracelessSyntax {
  ...
  class Animal: // the compiler expects the body of animal
    def eat(): Unit =
      println("I'm eating")
    end eat // recommended for blocks that are > 4 lines of code

    def grow(): Unit =
      println("I'm growing")

    // 3000 more lines of code
  end Animal // for if, matches, for, methods, classes, traits, enums, objects
  ...
  // should not indent with both spaces and tabs




  def main(args: Array[String]): Unit = {
    println(anIfIndentation_v5)
    println(computeMeaningOfLife(44))
  }
}
